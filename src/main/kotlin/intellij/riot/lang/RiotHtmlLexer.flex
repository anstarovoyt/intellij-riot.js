...
%{
  public _RiotHtmlLexer() {
    this((java.io.Reader)null);
  }
%}

%class _RiotHtmlLexer
%public
...
<ATTRIBUTE_VALUE_START> "{" { yybegin(ATTRIBUTE_VALUE_LBRACE); return XmlTokenType.XML_ATTRIBUTE_VALUE_START_DELIMITER; }
